define([
  ...
  'util', 
 // 'epoxy',
  '../../../assets/templates/handlebars/AttributeCreate.js'
  ...
  var AttributeCreateView = Backbone.View.extend({
    el: $('#content'),
    viewPanelEl: $("#Attribute-create"),
    ...
    saveNew : function(ev){
    	...
    	var formInput = $("#attribute-create input").serializeArray();
