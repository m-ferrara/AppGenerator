...
$route['webservice/apis/recent'] = "webservice/Api/collection_latest";
...
$route['webservice/attribute/id/(:num)/entities']  = "webservice/Entity_attribute_mapping/index/attr_id/$1";
