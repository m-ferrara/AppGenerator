<?php class Entity_key_mapping_model extends CI_Model {
    ...
    function get ($getArray)
    {
        ...
        $dbResult = $this-> db-> get("entity_key_mapping");
        return $dbResult-> result();
    } 
    function put ($putArray, $whereArray)
    {
        $dbWhere = $this-> db-> where($whereArray);
        $dbUpdate = $this-> db-> update("entity_key_mapping", $putArray);
        if ($dbUpdate) {
            return true;
        } else {
            return false;
    ...
    {
        $dbInsert = $this-> db-> insert("entity_key_mapping", $postArray);
        if ($dbInsert) {
    ...
    {
        $dbWhere = $this-> db-> where($whereArray);
        $dbDelete = $this-> db-> delete("entity_key_mapping");
    } 
    ...
    function getValidator($RequestPayload)
    {
        ...
        // Validation Rules
        $VldtnRules = array("ent_id" => "number");
        $MandatoryRules = array("ent_id");
        
        // Sanatization Rules
        $SntnRules = array("ent_id" => "number");
        $UniqueRules = array();
    ...
    function putValidator($RequestPayload)
    {
        ...
        // Validation Rules
        $VldtnRules = array("att_id" => "number", "ent_id" => "number", "is_primary_key" => "number");
        $MandatoryRules = array("att_id", "ent_id", "is_primary_key");
        
        // Sanatization Rules
        $SntnRules = array("att_id" => "number", "ent_id" => "number", "is_primary_key" => "number");
        $UniqueRules = array();
        $validator = new Custom_Validator($VldtnRules, $MandatoryRules, $SntnRules, $UniqueRules);
        if ($validator-> validate($RequestPayload)) {
            $sanatizedPayload = $validator-> sanatize($RequestPayload);
    ...
    function postValidator($RequestPayload)
    {
        ...
        // Validation Rules
        $VldtnRules = array("att_id" => "number", "ent_id" => "number", "is_primary_key" => "number");
        $MandatoryRules = array("att_id", "ent_id");
    ...
    function deleteValidator($RequestPayload)
    {
        ...
        // Validation Rules
        $VldtnRules = array("att_id" => "number", "ent_id" => "number");
        $MandatoryRules = array("att_id", "ent_id");
        
        // Sanatization Rules
        $SntnRules = array("att_id" => "number", "ent_id" => "number");
        $UniqueRules = array();
        $validator = new Custom_Validator($VldtnRules, $MandatoryRules, $SntnRules, $UniqueRules);
        if ($validator-> validate($RequestPayload)) {
            $sanatizedPayload = $validator-> sanatize($RequestPayload);
...
/**
 * end of Entity_key_mapping_model.php
 */