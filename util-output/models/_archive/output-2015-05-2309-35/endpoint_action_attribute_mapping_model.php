...
$VldtnRules = array("endpt_id"=>"number", "method"=>"alfanum");$MandatoryRules = array("endpt_id");

// Sanatization Rules 

$SntnRules = array("endpt_id"=>"number", "method"=>"alfanum");$UniqueRules = array();$validator = new Custom_Validator($VldtnRules, $MandatoryRules, $SntnRules, $UniqueRules);if ($validator->validate($RequestPayload)) {$sanatizedPayload = $validator->sanatize($RequestPayload);return array("isValid" => true, "payload" => $sanatizedPayload);} else {return array("isValid" => false, "errorMsg" => $validator->getJSON());}}function putValidator( $RequestPayload )  {

// Validation Rules 

$VldtnRules = array("id"=>"number", "endpt_id"=>"number", "attr_id"=>"number", "action_method"=>"undefined", "ent_id"=>"number", "attr_id"=>"number", "category"=>"alfanum", "action_method"=>"undefined");$MandatoryRules = array("id", "endpt_id", "attr_id", "action_method");

// Sanatization Rules 

$SntnRules = array("id"=>"number", "endpt_id"=>"number", "attr_id"=>"number", "action_method"=>"undefined", "ent_id"=>"number", "attr_id"=>"number", "category"=>"alfanum", "action_method"=>"undefined");$UniqueRules = array("endpt_id"=>"endpoint_action_attribute_mapping", "attr_id"=>"endpoint_action_attribute_mapping", "action_method"=>"endpoint_action_attribute_mapping");$validator = new Custom_Validator($VldtnRules, $MandatoryRules, $SntnRules, $UniqueRules);if ($validator->validate($RequestPayload)) {$sanatizedPayload = $validator->sanatize($RequestPayload);return array("isValid" => true, "payload" => $sanatizedPayload);} else {return array("isValid" => false, "errorMsg" => $validator->getJSON());}}function postValidator( $RequestPayload )  {

// Validation Rules 

$VldtnRules = array("endpt_id"=>"number", "attr_id"=>"number", "category"=>"alfanum", "action_method"=>"undefined");$MandatoryRules = array("endpt_id", "attr_id", "category", "action_method");

// Sanatization Rules 

$SntnRules = array("endpt_id"=>"number", "attr_id"=>"number", "category"=>"alfanum", "action_method"=>"undefined");$UniqueRules = array("endpt_id"=>"endpoint_action_attribute_mapping", "attr_id"=>"endpoint_action_attribute_mapping", "action_method"=>"endpoint_action_attribute_mapping");$validator = new Custom_Validator($VldtnRules, $MandatoryRules, $SntnRules, $UniqueRules);if ($validator->validate($RequestPayload)) {$sanatizedPayload = $validator->sanatize($RequestPayload);return array("isValid" => true, "payload" => $sanatizedPayload);} else {return array("isValid" => false, "errorMsg" => $validator->getJSON());}}function deleteValidator( $RequestPayload )  {
