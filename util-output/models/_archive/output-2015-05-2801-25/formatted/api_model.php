<?php class Api_model extends CI_Model {
    ...
    function assembleRequestParamArray($requestMethod)
    {
        ...
        case "get": $reqArray = $this -> getAssembler($requestPayload);
            return $reqArray;
            break;
        case "put": $reqArray = $this -> putAssembler($requestPayload);
            return $reqArray;
            break;
        case "post": $reqArray = $this -> postAssembler($requestPayload);
            return $reqArray;
            break;
        case "delete": $reqArray = $this -> deleteAssembler($requestPayload);
            return $reqArray;
            break;
        } 
    } 
