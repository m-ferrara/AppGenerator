...
$VldtnRules = array("name"=>"alfanum", "type"=>"alfanum", "length"=>"number", "regex_pattern"=>"anything", "is_primary_key"=>"number", "is_unique"=>"number");$MandatoryRules = array("name");
