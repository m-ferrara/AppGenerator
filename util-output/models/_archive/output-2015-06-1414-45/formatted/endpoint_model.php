<?php class Endpoint_model extends CI_Model {
    ...
    function getValidator($RequestPayload)
    {
        ...
        // Validation Rules
        $VldtnRules = array("ent_id" => "number", "id" => "number", "api_id" => "number", "ent_id" => "number");
        $MandatoryRules = array();
        $MandatoryOrRules = array(array("id", "api_id"));
        
        // Sanatization Rules
        $SntnRules = array("ent_id" => "number", "id" => "number", "api_id" => "number", "ent_id" => "number");
        $UniqueRules = array();
