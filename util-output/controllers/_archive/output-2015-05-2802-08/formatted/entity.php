...
class Entity extends REST_Controller {
    ...
    function index_get()
    {
        $getArray = $this -> entity_model -> assembleRequestPayload('get');
    ...
    function index_put()
    {
        ...
        $putArray = $this -> entity_model -> assembleRequestPayload('put');
    ...
    function index_post()
    {
        $postArray = $this -> entity_model -> assembleRequestPayload('post');
    ...
    {
        $deleteArray = $this -> entity_model -> assembleRequestPayload('delete');
