...
class Endpoint extends REST_Controller {
    ...
    function index_get()
    {
        $getArray = $this -> endpoint_model -> assembleRequestPayload('get');
    ...
    function index_put()
    {
        ...
        $putArray = $this -> endpoint_model -> assembleRequestPayload('put');
    ...
    function index_post()
    {
        $postArray = $this -> endpoint_model -> assembleRequestPayload('post');
    ...
    {
        $deleteArray = $this -> endpoint_model -> assembleRequestPayload('delete');
