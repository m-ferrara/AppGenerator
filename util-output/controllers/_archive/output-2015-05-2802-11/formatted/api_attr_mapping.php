...
class Api_attr_mapping extends REST_Controller {
    ...
    function index_get()
    {
        $getArray = $this -> api_attr_mapping_model -> assembleRequestPayload('get');
    ...
    function index_put()
    {
        ...
        $putArray = $this -> api_attr_mapping_model -> assembleRequestPayload('put');
    ...
    function index_post()
    {
        $postArray = $this -> api_attr_mapping_model -> assembleRequestPayload('post');
    ...
    {
        $deleteArray = $this -> api_attr_mapping_model -> assembleRequestPayload('delete');
