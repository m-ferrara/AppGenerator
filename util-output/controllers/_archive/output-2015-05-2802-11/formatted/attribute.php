...
class Attribute extends REST_Controller {
    ...
    function index_get()
    {
        $getArray = $this -> attribute_model -> assembleRequestPayload('get');
    ...
    function index_put()
    {
        ...
        $putArray = $this -> attribute_model -> assembleRequestPayload('put');
    ...
    function index_post()
    {
        $postArray = $this -> attribute_model -> assembleRequestPayload('post');
    ...
    {
        $deleteArray = $this -> attribute_model -> assembleRequestPayload('delete');
