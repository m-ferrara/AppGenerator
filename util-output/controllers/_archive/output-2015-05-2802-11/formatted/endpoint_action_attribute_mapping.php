...
class Endpoint_action_attribute_mapping extends REST_Controller {
    ...
    function index_get()
    {
        $getArray = $this -> endpoint_action_attribute_mapping_model -> assembleRequestPayload('get');
    ...
    function index_put()
    {
        ...
        $putArray = $this -> endpoint_action_attribute_mapping_model -> assembleRequestPayload('put');
    ...
    function index_post()
    {
        $postArray = $this -> endpoint_action_attribute_mapping_model -> assembleRequestPayload('post');
    ...
    {
        $deleteArray = $this -> endpoint_action_attribute_mapping_model -> assembleRequestPayload('delete');
